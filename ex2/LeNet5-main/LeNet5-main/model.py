...
class LeNet:
    def __init__(self):
        ...
        self.pool1 = layers.MaxPool((2, 2), 2)
        self.conv2 = layers.Conv(6, 16, 5)
        self.relu2 = layers.ReLu()
        self.pool2 = layers.MaxPool((2, 2), 2)
        self.fc1 = layers.FullyConnect(16 * 5 * 5, 120)
        self.relu3 = layers.ReLu()
        self.fc2 = layers.FullyConnect(120, 84)
        self.relu4 = layers.ReLu()
        self.fc3 = layers.FullyConnect(84, 10)
